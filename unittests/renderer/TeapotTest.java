...
public class TeapotTest {
    ...
    private final Camera.Builder camera = new Camera.Builder()
    ...
    public void teapot() {
        ...
        camera.setRayTracer(new SimpleRayTracer(scene)).build().renderImage(17).printGrid(50, new Color(YELLOW)).writeToImage();
    }
