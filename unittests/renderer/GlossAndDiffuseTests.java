        ...
        public void TestCombo() {
            ...
            scene.geometries.add(
                    new Sphere(50d, new Point(0, 0, 0))
                            .setMaterial(new Material().setkD(0.3).setkS(0.7).setnShininess(10).setkT(0.8))
                            .setEmission(new Color(RED)),
                    new Sphere(25d, new Point(0, 0, 0)).setMaterial(new Material().setkD(0.2).setkS(0.8).setnShininess(50))
